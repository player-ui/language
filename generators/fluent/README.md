...
```bash
pnpm i @player-lang/fluent-generator
```
...
```typescript
import { generateFluentBuilderWithWarnings } from "@player-lang/fluent-generator";
...
| ------------------------- | ------------------------------ | ------------------------ | ---------------------------------------------------------------------- |
| `fluentImportPath`        | `string`                       | `"@player-lang/fluent"` | Import path for fluent utilities                                       |
