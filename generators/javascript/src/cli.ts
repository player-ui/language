#!/usr/bin/env node
/**
 * CLI entry point for functional-generator
 */
...
function printHelp(): void {
  console.log(`
functional-generator - Generate functional builders from XLR types
...
from their package names (e.g., "@player-lang/types").
`);
}
...
async function main(): Promise<void> {
  ...
  console.log("━━━ Functional Generator ━━━");
