...
```bash
pnpm add @player-lang/fluent
```

### Your First Flow

```typescript
import { flow, binding as b, expression as e } from "@player-lang/fluent";
...
```typescript
import { binding as b, expression as e } from "@player-lang/fluent";
...
The Fluent DSL includes a code generator (`@player-lang/fluent-generator`) that creates type-safe builders from your TypeScript asset types.
...
} from "@player-lang/fluent-generator";
...
for (const assetType of result.data.types) {
  const config: GeneratorConfig = {
    fluentImportPath: "@player-lang/fluent",
...
import { text, binding as b } from "@player-lang/fluent";
...
import { extractBindingsFromSchema } from "@player-lang/fluent";
...
```typescript
import { and, or, greaterThan, lessThan, equal } from "@player-lang/fluent";
...
```typescript
import { globalIdRegistry } from "@player-lang/fluent";
...
```typescript
import { collection, text, template, binding as b } from "@player-lang/fluent";
...
```typescript
import { BaseBuildContext } from "@player-lang/fluent";
...
import { binding, expression } from "@player-lang/fluent";

// Flow creation
import { flow } from "@player-lang/fluent";
...
import { FluentBuilderBase } from "@player-lang/fluent";
```
...
interface GeneratorConfig {
  /** Import path for fluent utilities (default: "@player-lang/fluent") */
