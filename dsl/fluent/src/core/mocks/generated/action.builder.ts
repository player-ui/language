...
export interface ActionAssetBuilderMethods<AnyAsset extends Asset = Asset> {
  ...
  withMetaData(
    value:
      | ActionMetaData
      | FluentBuilder<ActionMetaData, BaseBuildContext>
      | FluentPartial<ActionMetaData, BaseBuildContext>,
  ): ActionAssetBuilder<AnyAsset>;
...
export class ActionAssetBuilder<AnyAsset extends Asset = Asset>
  extends FluentBuilderBase<ActionAsset<AnyAsset>>
  implements
    ActionAssetBuilderMethods<AnyAsset>,
    FluentBuilder<ActionAsset<AnyAsset>, BaseBuildContext>
{
...
export function action<AnyAsset extends Asset = Asset>(
  initial?: FluentPartial<ActionAsset<AnyAsset>>,
): ActionAssetBuilder<AnyAsset> {
