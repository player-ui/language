...
export interface ChoiceItemBuilderMethods<AnyAsset extends Asset = Asset> {
  ...
  withMetaData(
    value:
      | ChoiceItemMetadata
      | FluentBuilder<ChoiceItemMetadata, BaseBuildContext>
      | FluentPartial<ChoiceItemMetadata, BaseBuildContext>,
  ): ChoiceItemBuilder<AnyAsset>;
}
...
export class ChoiceItemBuilder<AnyAsset extends Asset = Asset>
  extends FluentBuilderBase<ChoiceItem<AnyAsset>>
  implements
...
export function choiceItem<AnyAsset extends Asset = Asset>(
  initial?: FluentPartial<ChoiceItem<AnyAsset>>,
): ChoiceItemBuilder<AnyAsset> {
