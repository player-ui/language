    ...
    DescribeSpec({
        ...
        describe("InputBuilder") {
            ...
            it("builds an input with nested label") {
                val ctx = BuildContext(parentId = "form", idRegistry = registry())
        ...
        describe("CollectionBuilder") {
            it("builds a collection with label") {
                val ctx = BuildContext(parentId = "page", idRegistry = registry())
            ...
            it("builds a collection with values array") {
                val ctx = BuildContext(parentId = "page", branch = IdBranch.Slot("content"), idRegistry = registry())
        ...
        describe("Nested ID generation") {
            it("generates hierarchical IDs for nested assets") {
                val ctx = BuildContext(parentId = "my-flow-views-0", idRegistry = registry())
