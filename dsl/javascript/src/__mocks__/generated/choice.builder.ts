...
export interface ChoiceAssetBuilderMethods<AnyAsset extends Asset = Asset> {
  ...
  withChoices(
    value: Array<
      ...
      | FunctionalPartial<ChoiceItem<AnyAsset>, BaseBuildContext>
    >,
  ): ChoiceAssetBuilder<AnyAsset>;
  ...
  withModifiers(
    value: Array<
      | ChoiceModifier
      | FunctionalBuilder<ChoiceModifier, BaseBuildContext>
      | FunctionalPartial<ChoiceModifier, BaseBuildContext>
      | ChoiceInputModifier
  ...
  withMetaData(
    value:
      | ChoiceMetaData
      | FunctionalBuilder<ChoiceMetaData, BaseBuildContext>
      | FunctionalPartial<ChoiceMetaData, BaseBuildContext>,
  ): ChoiceAssetBuilder<AnyAsset>;
...
export class ChoiceAssetBuilder<AnyAsset extends Asset = Asset>
  extends FunctionalBuilderBase<ChoiceAsset<AnyAsset>>
  implements
    ChoiceAssetBuilderMethods<AnyAsset>,
    FunctionalBuilder<ChoiceAsset<AnyAsset>, BaseBuildContext>
{
...
export function choice<AnyAsset extends Asset = Asset>(
  initial?: FunctionalPartial<ChoiceAsset<AnyAsset>>,
): ChoiceAssetBuilder<AnyAsset> {
