 ...
 */
export const TEMPLATE_MARKER = Symbol.for("functional-builder-template");
...
interface TemplateArgs<T extends Asset<string>> {
  ...
  /** The asset creator - can be a static asset, a FunctionalBuilder, or a builder function that returns an asset */
  readonly value:
    | T
