 ...
 * Handles intermediate FunctionalBuilders by resolving them before continuing traversal.
 */
function resolvePathInResult<C extends BaseBuildContext>(
  ...
  if (isFunctionalBuilder(value) || isAsset(value)) {
