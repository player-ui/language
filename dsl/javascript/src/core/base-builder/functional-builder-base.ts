 ...
 */
export abstract class FunctionalBuilderBase<
  T,
...
> {
   ...
   * @param initial - Optional initial values (accepts FunctionalPartial for TaggedTemplateValue support)
   */
  constructor(initial?: FunctionalPartial<T, C>) {
  ...
  private getArrayPropertiesMetadata(): ReadonlySet<string> {
    const constructor = this.constructor as typeof FunctionalBuilderBase & {
  ...
  public peekBuilder<K extends keyof T>(
    key: K,
  ): import("./types").FunctionalBuilder<T[K], C> | undefined {
