...
import type { TextAsset } from "../../../__mocks__/types/text";
import {
  action,
  text,
  input,
  ...
  choice,
  choiceItem,
} from "../../../__mocks__/generated";
import { resetGlobalIdSet } from "../";
import { binding as b, expression as e } from "../../tagged-template";
import { template } from "../../template";
import { Collection } from "../../../__mocks__/types/collection";
import { InputAsset } from "../../../__mocks__/types/input";
import { ActionAsset } from "../../../__mocks__/types/action";

describe("FunctionalBuilderBase - Basic Asset Creation", () => {
  beforeEach(() => {
    resetGlobalIdSet();
  });
...
describe("FunctionalBuilderBase - Nested Assets with ID Hierarchy", () => {
  beforeEach(() => {
    resetGlobalIdSet();
  });
...
describe("FunctionalBuilderBase - Conditional Methods (if, ifElse)", () => {
  beforeEach(() => {
    resetGlobalIdSet();
  });
...
describe("FunctionalBuilderBase - Template Integration", () => {
  beforeEach(() => {
    resetGlobalIdSet();
  });
...
describe("FunctionalBuilderBase - Switch Integration", () => {
  beforeEach(() => {
    resetGlobalIdSet();
  });
...
describe("FunctionalBuilderBase - Complex Real-World Scenarios", () => {
  beforeEach(() => {
    resetGlobalIdSet();
  });
...
describe("FunctionalBuilderBase - Type Compliance", () => {
  beforeEach(() => {
    resetGlobalIdSet();
  });
...
describe("FunctionalBuilderBase - Builder Utilities", () => {
  beforeEach(() => {
    resetGlobalIdSet();
  });
...
describe("FunctionalBuilderBase - Nested Objects ID Generation", () => {
  beforeEach(() => {
    resetGlobalIdSet();
  });
...
describe("FunctionalBuilderBase - Conditional Edge Cases", () => {
  beforeEach(() => {
    resetGlobalIdSet();
  });
