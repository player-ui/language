...
import { FunctionalBuilderBase } from "../functional-builder-base";
import { BaseBuildContext, FunctionalBuilder } from "../types";
...
class TestAssetBuilder
  extends FunctionalBuilderBase<TestAsset>
  implements FunctionalBuilder<TestAsset, BaseBuildContext>
{
  constructor() {
    super({ type: "test" });
  }
...
class CollectionBuilder
  extends FunctionalBuilderBase<CollectionAsset>
  implements FunctionalBuilder<CollectionAsset, BaseBuildContext>
{
  ...
  withValues(
    v: Array<FunctionalBuilder<Asset, BaseBuildContext> | Asset>,
  ): this {
...
describe("Switch Integration with FunctionalBuilderBase", () => {
  beforeEach(() => {
    resetGlobalIdSet();
  });
